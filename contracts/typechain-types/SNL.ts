...
export interface SNLInterface extends utils.Interface {
  contractName: "SNL";
  functions: {
  ...
  events: {
    ...
    "PlayerJoined(address,uint256)": EventFragment;
...
export type PlayerJoinedEvent = TypedEvent<
  [string, BigNumber],
  { playerAddr: string; time: BigNumber }
>;
...
export interface SNL extends BaseContract {
  contractName: "SNL";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SNLInterface;
  ...
  callStatic: {
    ...
    rollDice(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "GameWon(address,uint256)"(player?: null, time?: null): GameWonEventFilter;
    GameWon(player?: null, time?: null): GameWonEventFilter;

    "PlayerJoined(address,uint256)"(
      playerAddr?: string | null,
      time?: null
    ...
    PlayerMoved(player?: null, position?: null): PlayerMovedEventFilter;
